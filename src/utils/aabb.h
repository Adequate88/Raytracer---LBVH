...
inline const AABB AABB::empty    = AABB(+infinity, +infinity, +infinity, -infinity, -infinity, -infinity);
inline const AABB AABB::universe = AABB(-infinity, -infinity, -infinity, +infinity, +infinity, +infinity);
