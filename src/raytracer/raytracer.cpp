...
void Raytracer::recordBuffer(uint32_t image_index) {
  VkCommandBuffer computeCmd = _engine._computeCommandBuffers[_engine.frame_index];
  ...
  vkCmdBindDescriptorSets(computeCmd, VK_PIPELINE_BIND_POINT_COMPUTE, _layout, 0,
