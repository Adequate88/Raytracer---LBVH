#ifndef LBVH_KARRAS_CPU_H
#define LBVH_KARRAS_CPU_H
...
class lbvh_karras_cpu {
  public:
    lbvh_karras_cpu(std::vector<shared_ptr<hittable>>& objects)
    ...
    const std::vector<lbvh_karras_node>& get_nodes() const { return nodes; }
